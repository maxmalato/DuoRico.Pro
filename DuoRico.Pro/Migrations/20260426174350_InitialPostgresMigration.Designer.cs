...
namespace DuoRico.Pro.Migrations
{
    ...
    [Migration("20260426174350_InitialPostgresMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DuoRico.Pro.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DuoRico.Pro.Models.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuoRico.Pro.Models.Transaction", b =>
                {
                    b.HasOne("DuoRico.Pro.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DuoRico.Pro.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
